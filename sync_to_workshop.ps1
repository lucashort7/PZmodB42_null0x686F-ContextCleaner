...
$SourcePath = "C:\obsidian\pz-mods-byme\contextcleaner"
$DestPath = "C:\Users\lucas\Zomboid\Workshop\contextcleaner"

Write-Host "Syncing null0x686F ContextCleaner..." -ForegroundColor Cyan
